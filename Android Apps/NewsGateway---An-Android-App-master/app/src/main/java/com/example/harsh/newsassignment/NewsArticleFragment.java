...
public class NewsArticleFragment extends Fragment
{
    ...
    public static final NewsArticleFragment newInstance(String message, String message1, String message2, String message3, String message4, String message5, String message6)
    {
        ...
        if(message5 != null) {
            bdl.putString(NewsArticleFragment.f, message5);
        }
        if(message6 != null) {
...
//            String authorname1 = savedInstanceState.getString("author");
            ...
            mMyFragment = (NewsArticleFragment) manager.getFragment(savedInstanceState, "myFragment");
//            image.getImageAlpha()
        }
