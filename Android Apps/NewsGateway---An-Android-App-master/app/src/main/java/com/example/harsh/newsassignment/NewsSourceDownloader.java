...
public class NewsSourceDownloader extends AsyncTask<String, Void, String>
{
    ...
    private final String apiresourcekey ="&apiKey=4cd3be69311e47e789bc1f4c4c334518";
    ArrayList<SourceGetSet> newsresourcelist = new ArrayList<>();
    ArrayList<String> newsresourcecategory = new ArrayList<>();
    ArrayList<String> newsresourcecategory1 = new ArrayList<>();
    HashMap<Integer, SourceGetSet> map = new HashMap<>();
    ...
    protected String doInBackground(String... params)
    {
        ...
        ArrayList<SourceGetSet> newssource = parseJSON(sb.toString());
        return String.valueOf(newssource);
    }
    ...
    private ArrayList<SourceGetSet> parseJSON(String s)
    {
        ...
        try
        {
            ...
            for(int i =0; i<response1.length(); i++)
            {
                ...
                newsresourcelist.add(new SourceGetSet(cid, cname, curl, ccategory));
